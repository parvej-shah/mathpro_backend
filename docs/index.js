...
const managerialContest = require("./managerial_contest");
const managerialModule = require("./managerial_module");
const managerialLevel = require("./managerial_level");
const aftermessage = require("./aftermessage");
...
const managerialLive = require("./managerial_live");
  ...
  paths: {
    ...
    "/admin/live/list": {
      get: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "List of lives", // short desc
        operationId: "managerialLiveList", // unique operation id
        parameters: [],
        // requestBody: {
        //   // expected request body
        //   content: {
    ...
    "/user/live/list/{id}": {
      get: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "List of lives for user", // short desc
        operationId: "userLiveList", // unique operation id
        parameters: [
          {
            in: "path",
            name: "id",
            required: true,
            description: "Course id of the live you want to see list",
          },
        ],
        // requestBody: {
        //   // expected request body
    ...
    "/admin/live/get/{id}": {
      get: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "Get a single live", // short desc
        operationId: "manageriaLiveGet", // unique operation id
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/user/live/get/{id}": {
      get: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "Get a single live for user", // short desc
        operationId: "userLiveGet", // unique operation id
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/admin/live/create/{id}": {
      post: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "Create a live", // short desc
        operationId: "managerialLiveCreate", // unique operation id
        parameters: [
          {
            in: "path",
            name: "id",
            required: true,
            description: "Course id of the live you want to create",
          },
        ],
        requestBody: {
          // expected request body
          content: {
            ...
            "application/json": {
              schema: {
                $ref: "#/components/schemas/live", // todo input data model
              },
            },
          },
        },
    ...
    "/admin/live/update/{id}": {
      put: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "Update a live", // short desc
        operationId: "managerialLiveUpdate", // unique operation id
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/admin/live/delete/{id}": {
      delete: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "Delete a single live", // short desc
        operationId: "managerialLiveDelete", // unique operation id
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/user/live/interest/{liveId}": {
      post: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "Show interest to live", // short desc
        operationId: "userLiveInterest", // unique operation id
        parameters: [
          {
            in: "path",
            name: "liveId",
        ...
        responses: {
          200: {
            description: "Live Interest Submitted",
          },
          400: {
            description: "Interest Submission Failed",
          },
        },
      },
    },
    "/user/live/addFeed/{liveId}": {
      post: {
        security: [
          {
            bearerAuth: [],
        ...
        tags: ["Live Management"], // operation's tag
        description: "Add feed to a live", // short desc
        operationId: "userLiveAddFeed", // unique operation id
        parameters: [
          {
            in: "path",
            name: "liveId",
    ...
    "/user/live/getAllFeeds/{liveId}": {
      get: {
        ...
        tags: ["Live Management"], // operation's tag
        description: "get feeds of a live", // short desc
        operationId: "userLiveFeeds", // unique operation id
        parameters: [
          {
            in: "path",
            name: "liveId",
        ...
        responses: {
          200: {
            description: "Feedbacks fetched",
          },
          400: {
            description: "Feedback fetch error",
          },
        },
      },
    },
    "/user/meeting/getMeetingProps/{id}": {
      get: {
        security: [
          {
            bearerAuth: [],
        ...
        tags: ["Live Management"], // operation's tag
        description: "Get meeting props of a live", // short desc
        operationId: "userMeetingProps", // unique operation id
        parameters: [
          {
            in: "path",
            name: "id",
        ...
        responses: {
          200: {
            description: "Meeting Props Body",
          },
          400: {
            description: "Failed",
          },
    ...
    "/user/support/issue/create": {
      post: {
        ...
        tags: ["Support Dashboard"], // operation's tag
        description: "Create an issue", // short desc
        operationId: "userCreateIssue", // unique operation id
        parameters: [], // expected params
        requestBody: {
          // expected request body
          content: {
    ...
    "/user/support/issue/reopen/{issueId}": {
      put: {
        security: [
          {
            bearerAuth: [],
        ...
        tags: ["Support Dashboard"], // operation's tag
        description: "Reopen an issue", // short desc
        operationId: "userReopenIssue", // unique operation id
        parameters: [
          {
            in: "path",
            name: "issueId",
        ...
        responses: {
          ...
          400: {
            description: "Issue Reopening Failed",
          },
        },
      },
    },
    "/user/support/issue/resolve/{issueId}": {
      put: {
        ...
        tags: ["Support Dashboard"], // operation's tag
        description: "Resolve an issue", // short desc
        operationId: "userResolveIssue", // unique operation id
        parameters: [
          {
            in: "path",
            name: "issueId",
        ...
        responses: {
          ...
          400: {
            description: "Issue Resolving Failed",
          },
        },
      },
    },
    "/user/support/response/create/{issueId}": {
      post: {
        ...
        tags: ["Support Dashboard"], // operation's tag
        description: "Create a response", // short desc
        operationId: "userCreateResponse", // unique operation id
        parameters: [
          {
            in: "path",
            name: "issueId",
    ...
    "/user/support/issue/getAllPendingIssues": {
      get: {
        ...
        tags: ["Support Dashboard"], // operation's tag
        description: "Get all pending issues", // short desc
        operationId: "userGetAllPendingIssues", // unique operation id
        parameters: [], // expected params
        requestBody: {
          // expected request body
        },
        responses: {
          ...
          400: {
            description: "Issues Fetching Failed",
          },
        },
      },
    },
    "/user/support/issue/getMyIssues": {
      get: {
        security: [
          {
            bearerAuth: [],
        ...
        tags: ["Support Dashboard"], // operation's tag
        description: "Get my issues", // short desc
        operationId: "userGetMyIssues", // unique operation id
        parameters: [], // expected params
        requestBody: {
          // expected request body
        },
    ...
    // Managerial Contest Endpoints
    "/admin/contest/list/{id}": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Get list of contests for a course",
        operationId: "managerialContestList",
        parameters: [
          {
            in: "path",
            name: "id",
            required: true,
            description: "Course ID to get contests for",
          },
        ],
        responses: {
          200: {
          ...
          400: {
            description: "Failed to retrieve contests",
          },
        },
      },
    },
    "/admin/contest/get/{id}": {
      get: {
        ...
        operationId: "managerialContestGet",
        parameters: [
          {
            in: "path",
            name: "id",
        ...
        responses: {
          ...
          400: {
            description: "Failed to retrieve contest",
          },
        },
      },
    },
    "/admin/contest/create/{id}": {
      post: {
        ...
        operationId: "managerialContestCreate",
        parameters: [
          {
            in: "path",
            name: "id",
            required: true,
            description: "Course ID to create contest for",
          },
        ],
        requestBody: {
          content: {
    ...
    "/admin/contest/update/{id}": {
      put: {
        ...
        operationId: "managerialContestUpdate",
        parameters: [
          {
            in: "path",
            name: "id",
            required: true,
            description: "Contest ID to update",
          },
        ],
        requestBody: {
          content: {
    ...
    "/admin/contest/delete/{id}": {
      delete: {
        ...
        operationId: "managerialContestDelete",
        parameters: [
          {
            in: "path",
            name: "id",
            required: true,
            description: "Contest ID to delete",
          },
        ],
        responses: {
          200: {
    ...
    "/admin/contest/all": {
      get: {
        ...
        operationId: "managerialContestGetAll",
        responses: {
          200: {
    ...
    "/admin/contest/courses": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Get courses for contest dropdown",
        operationId: "managerialContestGetCourses",
        responses: {
          200: {
    ...
    "/admin/contest/users": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Get users for contest",
        operationId: "managerialContestGetUsers",
        parameters: [
          {
            in: "query",
            name: "search",
    ...
    "/admin/contest/participants/{id}": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Get participants of a contest",
        operationId: "managerialContestGetParticipants",
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/admin/contest/participant/add/{id}": {
      post: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Add a participant to contest",
        operationId: "managerialContestAddParticipant",
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/admin/contest/participant/remove/{id}": {
      post: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Remove a participant from contest",
        operationId: "managerialContestRemoveParticipant",
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/admin/contest/participant/score/{id}": {
      put: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Update participant score",
        operationId: "managerialContestUpdateParticipantScore",
        parameters: [
          {
            in: "path",
            name: "id",
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  userId: {
                    type: "integer",
                    description: "User ID to update score for",
                  },
                  score: {
                    type: "integer",
                    description: "New score for the participant",
                  },
                },
              },
            },
    ...
    "/admin/contest/leaderboard/{id}": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["Contest Management"],
        description: "Get contest leaderboard",
        operationId: "managerialContestGetLeaderboard",
        parameters: [
          {
            in: "path",
            name: "id",
    ...
    "/user/contest/course/{courseId}": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["User Contest"],
        description: "Get contests for a course",
        operationId: "userContestGetCourseContests",
        parameters: [
          {
            in: "path",
            name: "courseId",
        ...
        responses: {
          200: {
            description: "Course contests retrieved successfully",
          },
          400: {
            description: "Failed to retrieve course contests",
          },
        },
      },
    },
    "/user/contest/my-contests": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["User Contest"],
        description: "Get user's participated contests",
        operationId: "userContestGetMyContests",
        responses: {
          200: {
            description: "User's contests retrieved successfully",
          },
          400: {
            description: "Failed to retrieve user's contests",
          },
        },
      },
    },
    "/user/contest/leaderboard/{contestId}": {
      get: {
        security: [{ bearerAuth: [] }],
        tags: ["User Contest"],
        description: "Get contest leaderboard",
        operationId: "userContestGetLeaderboard",
        parameters: [
          {
            in: "path",
            name: "contestId",
    ...
    "/user/contest/join/{contestId}": {
      post: {
        security: [{ bearerAuth: [] }],
        tags: ["User Contest"],
        description: "Join a contest",
        operationId: "userContestJoin",
        parameters: [
          {
            in: "path",
            name: "contestId",
                      ...
                      properties: {
                        ...
                        profile: {
                          ...
                          properties: {
                            email: { type: "string", nullable: true, example: "john@example.com" },
                            phone: { type: "string", nullable: true, example: "01712345678" },
                            currentInstitution: { type: "string", nullable: true, example: "University of Dhaka" },
                            department: { type: "string", nullable: true, example: "CSE" },
                            currentAcademicLevel: { type: "string", nullable: true, enum: ["SSC", "HSC", "UNIVERSITY", "OTHERS"], example: "UNIVERSITY" },
                          },
                        },
                      },
                    },
              ...
              schema: {
                ...
                properties: {
                  ...
                  currentAcademicLevel: {
                    type: "string",
                    nullable: true,
                    enum: ["SSC", "HSC", "UNIVERSITY", "OTHERS"],
                      ...
                      properties: {
                        ...
                        profile: {
                          ...
                          properties: {
                            ...
                            currentInstitution: { type: "string", nullable: true, example: "University of Dhaka" },
                            department: { type: "string", nullable: true, example: "CSE" },
                            currentAcademicLevel: { type: "string", nullable: true, example: "UNIVERSITY" },
                          },
                        },
                      },
                    },
